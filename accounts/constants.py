...
USER_ADDED = 'Successfully added in the group.'
ADD_AFTER_SIGNUP = 'Do not have account.You will automatically added to the group after signup.'
...
EMAIL_SEND_ERROR = 'There was an error sending an email.'
EMAIL_SEND_FAILED = 'Failed to Send Mail.'
INVITATION_FAILED = 'Failed to invite User.'
